                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Informe de Artículos</h3>
                                    <div class="box-tools">
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="list-group">
                                                                <a href="articulo_rpt.php?opcion=1" class="list-group-item">Por Código</a>
                                                                <a href="articulo_rpt.php?opcion=2" class="list-group-item">Por Marca</a>
                                                                <a href="articulo_rpt.php?opcion=3" class="list-group-item">Por Artículo</a>
                                                                 <a href="articulo_rpt.php?opcion=4" class="list-group-item">Por Impuesto</a>
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            <?php
                                                                switch ($opcion) {
                                                                    case 1:  ?>
                                                                        <?php $articulo= consultas::get_datos("SELECT * FROM articulo");?>
                                                                                    ...
                                                                                    <div class="col-md-6 col-lg-6" >
                                                                                        <select class="form-control select2" name="vdesde">
                                                                                            <?php foreach ($articulo as $art) { ?>
                                                                                                <option value="<?php echo ($opcion==1)? $art['art_cod']:$art['art_descri'];?>">
                                                                                                    <?php echo ($opcion==1)?$art['art_cod']:$art['art_descri'];?></option>
                                                                                                        <?php }?>
                                                                                        </select>
                                                                                    </div>
                                                                            </div>
                                                                ...
                                                                <?php        break;
                                                                    case 2:    
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <select class="form-control select2" name="vmarca">
                                                                ...
                                                                <?php        break;
                                                                    case 3:
                                                                        $articulos = consultas::get_datos("select * from vi_articulo");
                                                                        ?>                                                          
                                                                            <div class="form-group">
