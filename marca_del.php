                        ...
                        <div class="box box-warning">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Borrar Marca</h3>
                                    <div class="box-tools">
                                        <a href="marca_index.php" class="btn btn-danger pull-right btn-sm" data-title="Volver" rel="tooltip" data-placement="top">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            <input type="text" class="form-control" name="vmar_descri" required="" readonly="" value="<?php echo $marcas[0]['mar_descri'] ?>">
                                        </div>
                                    </div>
                                </div>
