                ...
                <div class="row">
                    ...
                    <div class="box-header">
                            ...
                            <form action="modulos_control_.php" method="POST" accept_charset="utf-8" class="from-horizontal">
                                <?php $modulos= consultas::get_datos("select * from modulos where mod_cod=".$_GET['vmod_cod']) ?>
                                <div class="box-body">
                                    ...
                                    <div class="from-group">
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            ...
                                            <input type="hidden" name="vmod_cod" value="<?php echo $modulos[0]['mar_cod']?>">
                                            <input type="text" class="from-control" name="vmod_nombre" value="<?php echo $modulos[0]['mod_nombre']?>" required="" readonly="">
                                        </div>
                                    </div>
                                </div>
