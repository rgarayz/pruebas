                        ...
                        <div class="box box-warning">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Borrar Cargo</h3>
                                    <div class="box-tools">
                                        <a href="cargo_index.php" class="btn btn-danger pull-right btn-sm" data-title="Volver" rel="tooltip" data-placement="top">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            <input type="text" class="form-control" name="vcar_descri" required="" readonly="" value="<?php echo $cargo[0]['car_descri'] ?>">
                                        </div>
                                    </div>
                                </div>
