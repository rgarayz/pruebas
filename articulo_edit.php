                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-warning">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Editar Artículos</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="text" class="form-control" name="vart_codbarra" value="<?php echo $articulos[0]['art_codbarra']; ?>">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary btn-flat" type="button" data-toggle="modal" data-target="#registrar" data-title="Agregar Marca" rel="tooltip">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="vart_descri" required="" value="<?php echo $articulos[0]['art_descri']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2 col-md-2 col-sm-2">Precio Compra: </label>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="number" class="form-control" name="vart_precioc" required="" value="<?php echo $articulos[0]['art_precioc']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2 col-md-2 col-sm-2"> Precio Venta: </label>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="number" class="form-control" name="vart_preciov" value="<?php echo $articulos[0]['art_preciov']; ?>">
                                        </div>
                                    </div>   
                                </div>
