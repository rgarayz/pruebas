                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            ...
                            <form action="articulo_control.php" method="POST" accept-charset="utf-8" class="form-horizontal" enctype="multipart/form-data">
                                <div class="box-body">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="text" class="form-control" name="vart_codbarra">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2 col-md-2 col-sm-2">Imagen: </label>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="vart_imagen" required="">
                                        </div>
                                    </div>
