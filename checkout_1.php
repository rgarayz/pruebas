        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                    <label  class="control-label col-lg-3 col-sm-3 col-xs-3 col-md-3 text-black">Condición: <span class="text-danger">*</span></label>
                  <div class="col-lg-6 col-md-6">
                      <select class="form-control" name="vtipo_venta" required="" id="tipo_venta" onchange="tipoventa()">
                ...
                <div class="col-md-12">
                  <label for="c_address" class="text-black">Cant. Cuotas <span class="text-danger">*</span></label>
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-lg py-3 btn-block"><i class="fa fa-floppy-o"></i>Place Order</button>
                  </div>
