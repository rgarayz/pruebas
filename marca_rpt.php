                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="list-group">
                                                                <a href="marca_rpt.php?opcion=1" class="list-group-item">Por código</a>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6 col-lg-6" >
                                                                    <select class="form-control select2" name="vdesde">
                                                                        ...
                                                                        <option value="<?php echo ($opcion==1)? $mar['mar_cod']:$mar['mar_descri'];?>">
                                                                                        <?php echo ($opcion==1)?$mar['mar_cod']:$mar['mar_descri'];?></option>
                                                                                        <?php }?>
                                                                    </select>
                                                                </div>
                                                            </div>
