...
//COLOR DE TABLA
        ...
        $cargo = consultas::get_datos("select * from cargo where car_cod between ".$_REQUEST['vdesde']." and ".$_REQUEST['vhasta']." order by car_cod");
            }else{
        $cargo = consultas::get_datos("select * from cargo where car_descri between '".$_REQUEST['vdesde']."' and '".$_REQUEST['vhasta']."' order by car_descri");
            }
            }else{
