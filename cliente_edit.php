                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="vcli_nombre" required="" accept=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <textarea class="form-control" name="vcli_direcc" rows="3"><?php echo $clientes[0]['cli_direcc']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
