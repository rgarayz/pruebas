...
//COLOR DE TABLA
        ...
        if (!empty(isset($_REQUEST['vdesde'])) && !empty(isset($_REQUEST['vdesde'])) ) {
            ...
            $modulos = consultas::get_datos("select * from modulos where mod_nombre between '".$_REQUEST['vdesde']."' and '".$_REQUEST['vhasta']."' ORDER BY mod_nombre " );
               } 
            }else{
            ...
            $pdf->Cell(50,5,$modulos['mod_cod'], 1, 0, 'C', 1);
            $pdf->Cell(0,5,$modulos['mod_nombre'], 1, 0, 'L', 1);
            $pdf->Ln();
        }
