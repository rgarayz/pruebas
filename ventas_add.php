                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Agregar Ventas</h3>
                                    <div class="box-tools">
                                        <a href="ventas_index.php" class="btn btn-primary pull-right btn-sm" data-title="Volver" rel="tooltip" data-placement="top">
                                ...
                                <form action="ventas_control.php" method="POST" accept-charset="utf-8" class="form-horizontal">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group has-feedback">
                                            ...
                                            <label class="control-label col-lg-3 col-md-3 col-xs-3">Condición:</label>
                                            <div class="col-lg-3 col-md-3">
