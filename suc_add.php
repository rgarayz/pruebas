                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Agregar Sucursal</h3>
                                    <div class="box-tools">
                                        <a href="suc_index.php" class="btn btn-primary pull-right btn-sm" data-title="Volver" rel="tooltip" data-placement="top">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            <input type="text" class="form-control" name="vsuc_descri" required="" autofocus="">
                                        </div>
                                    </div>
                                </div>
