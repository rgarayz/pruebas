                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-danger">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Borrar Depósito</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="number" class="form-control" name="vdep_cod" required="" readonly=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="vdep_descri" required="" accept="" readonly=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="text" class="form-control" name="vid_sucursal" readonly=""
