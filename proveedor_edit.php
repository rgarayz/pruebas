                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="text" class="form-control" name="vprv_ruc" required="" autofocus=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="vprv_razonsocial" required="" accept=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <textarea class="form-control" name="vprv_direccion" rows="3"><?php echo $proveedor[0]['prv_direccion']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2 col-md-2 col-sm-2"> Teléfono: </label>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <input type="text" class="form-control" name="vprv_telefono"
